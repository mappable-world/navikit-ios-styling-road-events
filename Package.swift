...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MMKStylingRoadEvents",
            url: "https://mappableworld.s3.eu-west-3.amazonaws.com/MMKStylingRoadEvents-4.25.0.framework.zip",
            checksum: "70956c3ea74bf4a8ad26de3efef1128088b7eaf53a179bd961978d12978dca15"
        ),
        .target(
