...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MMKStylingRoadEvents",
            url: "https://mappableworld.s3.eu-west-3.amazonaws.com/MMKStylingRoadEvents-4.17.2.framework.zip",
            checksum: "18ad88330d183b364ebfdbdeb9efdd69fac4ba9cb8e68cf47075ae43be566905"
        ),
        .target(
